  ...
  return (
    <section className="py-10 lg:py-24">
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-between mr-2">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mx-6 md:mx-0" ref={ref}>
          <img
            className={`${
              inView && "opacity-100"
            } rounded-md transition-all duration-1000 ease-in opacity-0`}
            alt="placeholder"
            src={placeholder}
          />
          ...
          <img
            className={`${
              inView && "opacity-100"
            } rounded-md transition-all duration-1000 delay-1000 ease-in opacity-0`}
            alt="placeholder"
            src={placeholder}
          />
          ...
          <img
            className={`${
              inView && "opacity-100"
            } rounded-md transition-all duration-1000 delay-2000 ease-in opacity-0`}
            alt="placeholder"
            src={placeholder}
          />
        </div>
      ...
      <div className="flex items-center justify-center mt-20">
        <button
          className="uppercase text-zinc-600 tracking-wide font-semibold lg:text-xl py-3 px-4 rounded-md bg-yellow-500"
          type="button"
          onClick={handleClickGoToProjectsPage}
        >
          All Projects
        </button>
      </div>
