    ...
    <section className="bg-zinc-50 relative">
      <div className="grid grid-cols-5 relative">
        ...
        <div
          ...
          } bg-zinc-50 rounded-md py-12 sm:py-18 md:py-24 lg:py-28 pl-10 sm:pl-24 lg:pl-44 pr-2 lg:pr-16 sm:pr-6 mr-16 absolute top-16 md:top-24 xl:top-32 max-w-xs sm:max-w-lg lg:max-w-3xl xl:max-w-4xl  transform duration-1000 ease-in translate-x-full
          `}
        >
          <h2
