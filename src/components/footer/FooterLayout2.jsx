  ...
  return (
    <footer className="bg-zinc-800 text-zinc-300">
        ...
        <div className="md:flex lg:mx-36 my-12 text-xl">
          <div className="flex flex-col justify-center md:justify-start md:items-start md:flex-grow md:m-0">
            ...
            <div className="flex my-12">
              <div className="bg-yellow-500 rounded-full py-8 px-5">
                <p className="text-zinc-800 uppercase tracking-wide font-bold md:text-xl">
                  logo
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-row justify-center items-center w-full">
            ...
            <div className="mr-14 cursor-pointer">
              <svg
                ...
                className="fill-zinc-50 hover:fill-yellow-500"
              >
                <path d="M0.294922 7C0.294922 3.13401 3.42893 0 7.29492 0H43.2949C47.1609 0 50.2949 3.13401 50.2949 7V43C50.2949 46.866 47.1609 50 43.2949 50H7.29492C3.42893 50 0.294922 46.866 0.294922 43V7Z" />
                <path
      ...
      <div className="bg-zinc-900 flex justify-center items-center">
        <p className="text-xs md:text-sm border-t-2 px-16 md:px-20 py-4">
          Copyright © 2022 Rhiannon Thompson
        </p>
      </div>
    </footer>
  );
